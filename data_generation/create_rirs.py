...
path_DIRPAT_file_mic="/home/psrivastava/pyroomacoustics/pyroomacoustics/AKG_c480_c414_CUBE.sofa"
path_DIRPAT_file_mic_em32="/home/psrivastava/pyroomacoustics/pyroomacoustics/EM32_Directivity.sofa"
...
file_name_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/ICASSP/dcase_arr/EM_32/generated_rirs_EM_32_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
file_name_anno_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/ICASSP/dcase_arr/EM_32/EM_32_anno_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
...
with open('/home/psrivastava/source_localization/doa_estimation/dcase_mic_arr/data_generation/EM_32/conf_room_setup_EM32.yml') as f:
    room_setup = yaml.load(f, Loader=SafeLoader)


with open('/home/psrivastava/source_localization/doa_estimation/dcase_mic_arr/data_generation/EM_32/conf_receivers_EM32.yml') as f_1:
    receiver_rooms = yaml.load(f_1, Loader=SafeLoader)


with open('/home/psrivastava/source_localization/doa_estimation/dcase_mic_arr/data_generation/EM_32/conf_source_EM32.yml') as f_2:
    source_rooms = yaml.load(f_2, Loader=SafeLoader)

with open('/home/psrivastava/source_localization/doa_estimation/dcase_mic_arr/data_generation/EM_32/conf_noise_source_EM32.yml') as f_3:
...
for room_no in tqdm(divided_rooms[parallel_batch_no]):
    ...
    dir_obj_Dsrc_1.obj_open_sofa_inter.change_orientation(source_rooms[room_id]["source_ypr"][0][0],source_rooms[room_id]["source_ypr"][0][1])

    room.add_source(source_rooms[room_id]["source_pos"][1],directivity=dir_obj_Dsrc_2)
    dir_obj_Dsrc_2.obj_open_sofa_inter.change_orientation(source_rooms[room_id]["source_ypr"][1][0],source_rooms[room_id]["source_ypr"][1][1])

    room.add_source(source_rooms[room_id]["source_pos"][2],directivity=dir_obj_Dsrc_3)
    dir_obj_Dsrc_3.obj_open_sofa_inter.change_orientation(source_rooms[room_id]["source_ypr"][2][0],source_rooms[room_id]["source_ypr"][2][1])
    ...
    mic_locs=np.c_[receiver_rooms[room_id]["barycenter_mic"][0],receiver_rooms[room_id]["barycenter_mic"][0]]
    ...
    packed_rir=np.zeros((6,max_len_rir)) #3 mics per array where mic array is fixed and 3 different source position.
    ...
    rir_id_anno.create_dataset("barycenter",(1,3),data=receiver_rooms[room_id]["barycenter"])
    rir_id_anno.create_dataset("rec_pos",(1,2,3),data=receiver_rooms[room_id]["rec_pos"])
