...
class util_receiver():
    ...
    def generate_receivers_rooms(self,room_dimension,different_no_receivers,saftey_distance,room_id,mic_in_ula=None):
        ...
        for x in range(different_no_receivers):
            ...
            barycenter=np.array([round(random.uniform(0.4,(room_dimension[0]-saftey_distance)),3),
            round(random.uniform(0.4,(room_dimension[1]-saftey_distance)),3),
            round(random.uniform(0.4,(room_dimension[2]-saftey_distance)),3)])
...
class conf_files(util_room,util_receiver):
    ...
    def room_file(self):
        ...
        saftey_distance=0.6 #Saftey distance between source and microphone with the room walls.
