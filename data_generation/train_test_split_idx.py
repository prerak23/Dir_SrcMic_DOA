...
no_rooms=40000
tmp_=[]
for i in range(no_rooms): #It starts from room 1 and goes until room 19999, so basically train-test split misses two room's : room_0, room_20000
    for j in range(1): # We change value here to include more than one sources in the training dataset.
...
train,val=(total_samples*95)/100,(total_samples*5)/100#,(total_samples*10)/100
