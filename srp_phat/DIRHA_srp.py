...
for b in np.arange(data.shape[0]):
    ...
    delay=pra.experimental.localization.tdoa(data_16k[0,:],data_16k[1,:],distance_between_mic,interp=4,fs=16000)
    ...
    estimated_angle=np.rad2deg(np.arccos((delay*speed_of_sound)/(distance_between_mic)))
